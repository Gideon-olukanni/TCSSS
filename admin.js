...
const COUNCIL_ROLES = [
  "Senior Prefect (Boy)",
  "Senior Prefect (Girl)",
  "Assistant Senior Prefect Boy",
  "Assistant Senior Prefect Girl",
  "Labour Prefect Boy",
  "Labour Prefect Girl",
  "Laboratory Prefect Boy",
  "Laboratory Prefect Girl",
  "Health Prefect Boy",
  "Health Prefect Girl",
  "Sport Prefect Boy",
  "Sport Prefect Girl",
  ...
  "Food Prefect Boy",
  "Food Prefect Girl",
  "Muslim Assembly Prefect Boy",
  "Muslim Assembly Prefect Girl",
  "Christian Assembly Prefect Boy",
  "Christian Assembly Prefect Girl",
  "Punctuality Prefect Boy",
  "Punctuality Prefect Girl",
  "Time Keeper Boy",
  "Time Keeper Girl",
  "Other"
];
...
async function loadPrincipals() {
  ...
  renderList("principalList", items, "No principal records yet.", (item) => {
    ...
    const subtitle = `${escapeHtml(item.yearStarted || "?")} – ${item.isCurrent ? "Till date" : escapeHtml(item.yearEnded || "?")}`;
    return createRow({
      thumb: item.photoUrl || "",
      title,
      subtitle,
...
async function savePrincipals(event) {
  ...
  try {
    ...
    if (!isCurrent && !payload.yearEnded) throw new Error("Year ended is required for a past principal.");
...
$("#principalCurrent").addEventListener("change", updatePrincipalYearEndedField);
